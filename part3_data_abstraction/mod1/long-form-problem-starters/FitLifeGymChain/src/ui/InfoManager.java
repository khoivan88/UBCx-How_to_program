...
public class InfoManager {
    ...
    //write a command shortcut for your gym's name between the quotes below.
    //The command MUST be in lowercase.
    private static final String YOUR_GYM_COMMAND = "igym";
    ...
    private void printInstructions(){
        ...
        //uncomment the next method call:
...
//        and call printRegisteredMembers
        if (eligible) {
            fc.registerMember(m);
            System.out.println("Confirm! " + m.getName() + " has been registered for Fitness Class " + fc.getClassName());
            printRegisteredMembers(fc);
        }
        //if the member is not eligible, print out the message below:
        else {
    ...
    private void printRegisteredMembers(FitnessClass fc){
        ...
        //write a foreach loop that prints out the name of each member in memberList
