...
public class GymChainInfo {
    ...
    public static final String YOUR_GYM_NAME = "My imaginary Gym";
    public static final String YOUR_MEMBER_NAME = "iGym iMember1";
...
//        for (Gym gym: chain.getGyms()) {
//            System.out.println(gym.getLocationName());
//        }
